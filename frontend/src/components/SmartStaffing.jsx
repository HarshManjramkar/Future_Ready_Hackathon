          ...
          <div className="flex-1 min-h-[250px] w-full mt-4">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={historicalData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                ...
                />
                <Area type="monotone" dataKey="Mathematics" stroke="rgb(249, 115, 22)" strokeWidth={3} fillOpacity={1} fill="url(#colorMath)" />
                <Area type="monotone" dataKey="Science" stroke="rgb(14, 165, 233)" strokeWidth={3} fillOpacity={1} fill="url(#colorScience)" />
              </AreaChart>
            </ResponsiveContainer>
          </div>
        </div>
